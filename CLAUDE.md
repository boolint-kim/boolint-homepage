...
### 랜딩 페이지 깊이
- **풀랜딩**: satpic, camlocation, myweather, agemap, snapatlas, universedaily, acqtax, officetradechart, apttradechart, weathertw, weatherno, propertytax, realestatecal, transtax, seoullife, busanlife (히어로 + 다단 섹션 + 스크린샷)
- **stub**: gifttax, junsewolse, myweathertw, finedustmap, iconmixer, englishnumber (이름 + 한 줄 + Play Store 링크). 추후 풀랜딩으로 확장 예정.
